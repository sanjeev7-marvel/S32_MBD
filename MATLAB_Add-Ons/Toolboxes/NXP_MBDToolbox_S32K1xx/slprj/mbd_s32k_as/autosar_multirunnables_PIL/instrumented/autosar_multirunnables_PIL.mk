...
HOST            = PC
BUILD           = yes
SYS_TARGET_FILE = mbd_s32k_as.tlc
...
MODEL                = autosar_multirunnables_PIL
MODULES              = autosar_multirunnables_PIL.c clock_S32K1xx.c interrupt_manager.c lpit_driver.c pins_driver.c pins_port_hw_access.c power_manager.c power_manager_S32K1xx.c power_smc_hw_access.c startup.c system_S32K144.c
MAKEFILE             = autosar_multirunnables_PIL.mk
MATLAB_ROOT          = C:\Program Files\MATLAB\R2018b
ALT_MATLAB_ROOT      = C:\PROGRA~1\MATLAB\R2018b
START_DIR            = C:\Users\shivama\AppData\Roaming\MathWorks\MATLAB_Add-Ons\Toolboxes\NXP_MBDToolbox_S32K1xx
S_FUNCTIONS          = 
S_FUNCTIONS_LIB      = 
SOLVER               = 
NUMST                = 4
...
MEM_ALLOC            = RT_STATIC
COMPUTER             = PCWIN64
BUILDARGS            = COPY_MDLREF_INCLUDES=0 GENERATE_ERT_S_FUNCTION=0 INCLUDE_MDL_TERMINATE_FCN=0 COMBINE_OUTPUT_UPDATE_FCNS=1 MULTI_INSTANCE_CODE=0 INTEGER_CODE=0 ISPROTECTINGMODEL=NOTPROTECTING
MULTITASKING         = 1
MAT_FILE             = 0
GENERATE_ASAP2 	     = 0
EXT_MODE             = 0
...
MODELREFS            = 
SHARED_SRC           = 
SHARED_SRC_DIR       = ..\..\..\..\slprj\mbd_s32k_as\_sharedutils
SHARED_BIN_DIR       = ..\..\..\..\slprj\mbd_s32k_as\_sharedutils\instrumented
SHARED_LIB           = 
...
MODELLIB                  = autosar_multirunnables_PIL_rtwlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	...
	-$(include_opt)$(START_DIR)\slprj\mbd_s32k_as\autosar_multirunnables_PIL\instrumented \
	-$(include_opt)$(START_DIR)\S32_Examples\autosar \
	-$(include_opt)C:\ProgramData\MATLAB\SupportPackages\R2018b\toolbox\coder\autosar\rte \
	...
	-$(include_opt)$(START_DIR)\slprj\mbd_s32k_as\_sharedutils \
...
###################################
%.o : $(START_DIR)\mbdtbx_s32k_as\blocks/%.c
	@echo ### "$(START_DIR)\mbdtbx_s32k_as\blocks\$*.c"o
    ifeq ($(TARGET_COMPILER), GreenHills Multi)
