/*
 * autosar_multirunnables_PIL_psf.c
 *
 * Automatically generated s-function with I/O interface for:
 * Component: autosar_multirunnables_PIL
 * Component Simulink Path: autosar_multirunnables_PIL
 * Simulation Mode: PIL
 *
 */

#define S_FUNCTION_NAME                autosar_multirunnables_PIL_psf
...
static RegMdlInfo rtMdlInfo_autosar_multirunnables_PIL[1] = {
  { "rtMdlrefDWork_autosar_multirunnables_PIL", MDL_INFO_NAME_MDLREF_DWORK, 0,
    -1, (void *) "autosar_multirunnables_PIL" }
};
  ...
  memUnitSizeBytes)
{
  ...
  pCodeInstrServiceData->infoPath =
    "C:/Users/shivama/AppData/Roaming/MathWorks/MATLAB_Add-Ons/Toolboxes/NXP_MBDToolbox_S32K1xx/slprj/mbd_s32k_as/autosar_multirunnables_PIL/pil";
 ...
 * system "autosar_multirunnables_PIL_Runnable1".
 * This function is explicitly called
 * by the function-call initiator which drives input port 0
 * of this S-Function.
 */
static ssFcnCallErr_T autosar_multirunnables_PIL_Runnable1_sf(SimStruct *S,
  int_T ssEl, int_T ssTid)
{
  /* Reserved arguments */
  (void)ssEl;
  (void)ssTid;

  {
...

    {
      ...
      if (IOBufferPtr != NULL) {
        void * pXILService = (void *) ssGetPWorkValue(S, 9);
        if (pXILService != NULL) {
          if (xilHostAppSvcGrowIOBuffer(pXILService, IOBufferPtr, 34, 0)!=
              XILHOSTAPPSVC_SUCCESS) {
    ...
    {
      {
        ...
        /* dispatch command to the target */
        if (commandDispatch(S, IOBufferPtr, 34)!=XILHOSTAPPSVC_SUCCESS) {
          return SS_FCNCALL_ERR;
        }                              /* if */
...
/*
 * This function is a wrapper around the "output-update" function for
 * system "autosar_multirunnables_PIL_Runnable2".
 * This function is explicitly called
 * by the function-call initiator which drives input port 1
 * of this S-Function.
 */
static ssFcnCallErr_T autosar_multirunnables_PIL_Runnable2_sf(SimStruct *S,
  int_T ssEl, int_T ssTid)
{
  /* Reserved arguments */
  (void)ssEl;
...
/*
 * This function is a wrapper around the "output-update" function for
 * system "autosar_multirunnables_PIL_Runnable3".
 * This function is explicitly called
 * by the function-call initiator which drives input port 2
 * of this S-Function.
 */
static ssFcnCallErr_T autosar_multirunnables_PIL_Runnable3_sf(SimStruct *S,
  int_T ssEl, int_T ssTid)
{
  /* Reserved arguments */
  (void)ssEl;
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  ssSetInputPortDataType(S, 1, SS_FCN_CALL);
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
  ...
  ssSetInputPortDataType(S, 2, SS_FCN_CALL);
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
  ...
  if (!ssSetInputPortVectorDimension(S, 5, 2))
    return;
  ...
  ssExportOutputFcn(S, 2, autosar_multirunnables_PIL_Runnable3_sf);
  ssExportOutputFcn(S, 1, autosar_multirunnables_PIL_Runnable2_sf);
  ssExportOutputFcn(S, 0, autosar_multirunnables_PIL_Runnable1_sf);
  ssSetModelReferenceSampleTimeInheritanceRule(S,
    DISALLOW_SAMPLE_TIME_INHERITANCE);
  ...
  if (S->mdlInfo->genericFcn != (NULL) &&
    ...
    ssRegModelRefMdlInfo(S, "autosar_multirunnables_PIL",
                         rtMdlInfo_autosar_multirunnables_PIL, 1);
  }
