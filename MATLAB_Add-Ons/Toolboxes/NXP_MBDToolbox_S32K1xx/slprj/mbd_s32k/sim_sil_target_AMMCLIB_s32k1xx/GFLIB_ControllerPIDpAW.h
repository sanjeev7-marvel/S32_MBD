...
****************************************************************************/
  ...
  *//**********************************************************************/
  ...
  typedef struct{
    tFrac32 f32PropGain;        /**< Proportional Gain, fractional format normalized to fit into (0, 2\f$^{31}\f$-1). */
    tFrac32 f32IntegGain;       /**< Integral Gain, fractional format normalized to fit into  (0, 2\f$^{31}\f$-1). */
    tFrac32 f32DerivGain;       /**< Derivative Gain, fractional format normalized to fit into  (0, 2\f$^{31}\f$-1). */
    tFrac32 f32FiltCoef;        /**< Derivative term filter coefficient, fractional format in range (0, 2\f$^{31}\f$-1). */
...
****************************************************************************/
  ...
  *//**********************************************************************/
  /* @remarks Implements DGFLIB00448 */
  typedef struct{
    tFrac16 f16PropGain;        /**< Proportional Gain, fractional format normalized to fit into (0, 2\f$^{15}\f$-1). */
    tFrac16 f16IntegGain;       /**< Integral Gain, fractional format normalized to fit into  (0, 2\f$^{15}\f$-1). */
    tFrac16 f16DerivGain;       /**< Derivative Gain, fractional format normalized to fit into  (0, 2\f$^{15}\f$-1). */
    tFrac16 f16FiltCoef;        /**< Derivative term filter coefficient, fractional format in range (0, 2\f$^{15}\f$-1). */
