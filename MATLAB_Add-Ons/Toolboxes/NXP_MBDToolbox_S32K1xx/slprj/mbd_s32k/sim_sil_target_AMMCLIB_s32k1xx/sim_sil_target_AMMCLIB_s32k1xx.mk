...
MODEL                = sim_sil_target_AMMCLIB_s32k1xx
MODULES              = mbd_hw_init.c rtiostream_uart_init.c sim_sil_target_AMMCLIB_s32k1xx.c clock_S32K1xx.c edma_driver.c edma_hw_access.c edma_irq.c interrupt_manager.c lin_common.c lin_driver.c lin_irq.c lin_lpuart_driver.c lpit_driver.c lpuart_driver.c lpuart_hw_access.c lpuart_irq.c osif_baremetal.c pins_driver.c pins_port_hw_access.c power_manager.c power_manager_S32K1xx.c power_smc_hw_access.c rtiostream_serial.c s32k_clock_init.c startup.c system_S32K144.c
MAKEFILE             = sim_sil_target_AMMCLIB_s32k1xx.mk
...
MODELREFS            = 
SHARED_SRC           = 
SHARED_SRC_DIR       = ..\..\..\slprj\mbd_s32k\_sharedutils
SHARED_BIN_DIR       = ..\..\..\slprj\mbd_s32k\_sharedutils
SHARED_LIB           = 
...
MODELLIB                  = sim_sil_target_AMMCLIB_s32k1xx_rtwlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	...
	-$(include_opt)$(START_DIR)\slprj\mbd_s32k\sim_sil_target_AMMCLIB_s32k1xx \
	-$(include_opt)$(START_DIR)\S32_Examples\common\sil\ammclib \
	...
	-$(include_opt)$(START_DIR)\slprj\mbd_s32k\_sharedutils \
