...
#ifndef __FREEMASTER_S32K14X_H
#define __FREEMASTER_S32K14X_H
...
#define FMSTR_UART_CTRL_OFFSET         0x18
#define FMSTR_UART_STAT_OFFSET         0x14
#define FMSTR_UART_DATA_OFFSET         0x1c

/* UART(SCI) Status registers bits */
#define FMSTR_SCISR_RDRF               0x00200000ul              /* RDRF - data receive flag */
#define FMSTR_SCISR_TDRE               0x00800000ul              /* TDRE - data transmit flag */

/* UART(SCI) Interrupt Enable Register bits */
#define FMSTR_UARTCR_TXEN              0x00800000ul
#define FMSTR_UARTCR_RXEN              0x00200000ul
...
#define FMSTR_IDT_STRING               "S32K1xx FreeMASTER"
...
/*********************************************************************************
 * communication buffer access functions. Most of them are trivial simple on S32K14X
 *********************************************************************************/
...
/* FlexCAN functionality tested on S32K144 */
...
#define FMSTR_TSTBIT8(base, offset, bit) (*(volatile FMSTR_U8*)(((FMSTR_U32)(base))+(offset)) & (bit))
...
#define FMSTR_SCI_ETXI()               FMSTR_SETBIT32(FMSTR_SCI_BASE, FMSTR_UART_CTRL_OFFSET, FMSTR_UARTCR_TXEN)
#define FMSTR_SCI_DTXI()               FMSTR_CLRBIT32(FMSTR_SCI_BASE, FMSTR_UART_CTRL_OFFSET, FMSTR_UARTCR_TXEN)

/* Receiver-full interrupt enable/disable */
#define FMSTR_SCI_ERXI()               FMSTR_SETBIT32(FMSTR_SCI_BASE, FMSTR_UART_CTRL_OFFSET, FMSTR_UARTCR_RXEN)
#define FMSTR_SCI_DRXI()               FMSTR_CLRBIT32(FMSTR_SCI_BASE, FMSTR_UART_CTRL_OFFSET, FMSTR_UARTCR_RXEN)

/* Transmit character */
#define FMSTR_SCI_PUTCHAR(ch)          FMSTR_SETREG32(FMSTR_SCI_BASE, FMSTR_UART_DATA_OFFSET, (FMSTR_U8)(ch))

/* Get received character */
#define FMSTR_SCI_GETCHAR()            ((FMSTR_U8) FMSTR_GETREG32(FMSTR_SCI_BASE, FMSTR_UART_DATA_OFFSET))

/* read status register */
#define FMSTR_SCI_GETSR()              FMSTR_GETREG32(FMSTR_SCI_BASE, FMSTR_UART_STAT_OFFSET)

/* read & clear status register  */
static inline FMSTR_SCISR FMSTR_SCI_RDCLRSR(void)
{
  FMSTR_SCISR sr = FMSTR_GETREG32(FMSTR_SCI_BASE, FMSTR_UART_STAT_OFFSET);
  FMSTR_SETREG32(FMSTR_SCI_BASE, FMSTR_UART_STAT_OFFSET, sr & (FMSTR_SCISR_RDRF|
    FMSTR_SCISR_TDRE));
  return sr;
}
