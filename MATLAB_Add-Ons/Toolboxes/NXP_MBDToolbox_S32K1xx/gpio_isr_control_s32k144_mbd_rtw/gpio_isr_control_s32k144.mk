...
MODEL                = gpio_isr_control_s32k144
MODULES              = mbd_main.c clock_S32K1xx.c gpio_irq.c interrupt_manager.c lpit_driver.c pins_driver.c pins_port_hw_access.c power_manager.c power_manager_S32K1xx.c power_smc_hw_access.c s32k_clock_init.c startup.c system_S32K144.c
MAKEFILE             = gpio_isr_control_s32k144.mk
...
MODELLIB                  = gpio_isr_control_s32k144lib.lib
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	...
	-$(include_opt)$(START_DIR)\gpio_isr_control_s32k144_mbd_rtw \
	-$(include_opt)$(START_DIR)\S32_Examples\s32k14x\gpio \
