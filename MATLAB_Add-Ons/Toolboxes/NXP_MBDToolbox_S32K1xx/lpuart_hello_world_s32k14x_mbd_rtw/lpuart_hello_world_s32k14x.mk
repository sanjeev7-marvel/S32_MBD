...
MODELLIB                  = lpuart_hello_world_s32k14xlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	...
	-$(include_opt)$(START_DIR)\lpuart_hello_world_s32k14x_mbd_rtw \
	-$(include_opt)$(START_DIR)\S32_Examples\s32k14x\lpuart \
...
%.o : $(START_DIR)\mbdtbx_s32k\blocks\lpuart/%.c
	@echo ### "$(START_DIR)\mbdtbx_s32k\blocks\lpuart\$*.c"o
    ifeq ($(TARGET_COMPILER), GreenHills Multi)
