...
MODEL                = adc_pdb_trigger_s32k14x
MODULES              = freemaster_interface_init.c mbd_main.c pdb0_isr.c pdb0_params.c adc_driver.c clock_S32K1xx.c edma_driver.c edma_hw_access.c edma_irq.c freemaster_S32K1xx.c freemaster_appcmd.c freemaster_protocol.c freemaster_rec.c freemaster_scope.c freemaster_serial.c freemaster_sfio.c freemaster_tsa.c interrupt_manager.c lin_common.c lin_driver.c lin_irq.c lin_lpuart_driver.c lpit_driver.c lpuart_driver.c lpuart_hw_access.c lpuart_irq.c mbd_adc_irq.c osif_baremetal.c pdb_driver.c pdb_hw_access.c pins_driver.c pins_port_hw_access.c power_manager.c power_manager_S32K1xx.c power_smc_hw_access.c s32k_clock_init.c startup.c system_S32K144.c trgmux_driver.c trgmux_hw_access.c
MAKEFILE             = adc_pdb_trigger_s32k14x.mk
...
MODELLIB                  = adc_pdb_trigger_s32k14xlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	...
	-$(include_opt)$(START_DIR)\adc_pdb_trigger_s32k14x_mbd_rtw \
	-$(include_opt)$(START_DIR)\S32_Examples\s32k14x\adc \
...
%.o : $(START_DIR)\mbdtbx_s32k\blocks\pdb/%.c
	@echo ### "$(START_DIR)\mbdtbx_s32k\blocks\pdb\$*.c"o
    ifeq ($(TARGET_COMPILER), GreenHills Multi)
	$(CC) -c -MD $(CC_OPTS) $(CFLAGS) -o $@ $<
    else
	@$(CC) $(CC_OPTS) $(CFLAGS) $<
    endif
%.o : $(START_DIR)\mbdtbx_s32k\blocks\adc/%.c
	@echo ### "$(START_DIR)\mbdtbx_s32k\blocks\adc\$*.c"o
    ifeq ($(TARGET_COMPILER), GreenHills Multi)
	$(CC) -c -MD $(CC_OPTS) $(CFLAGS) -o $@ $<
    else
	@$(CC) $(CC_OPTS) $(CFLAGS) $<
    endif
%.o : $(START_DIR)\mbdtbx_s32k\blocks\gpio/%.c
	@echo ### "$(START_DIR)\mbdtbx_s32k\blocks\gpio\$*.c"o
    ifeq ($(TARGET_COMPILER), GreenHills Multi)
	$(CC) -c -MD $(CC_OPTS) $(CFLAGS) -o $@ $<
    else
	@$(CC) $(CC_OPTS) $(CFLAGS) $<
    endif
%.o : $(START_DIR)\mbdtbx_s32k\blocks\fm/%.c
	@echo ### "$(START_DIR)\mbdtbx_s32k\blocks\fm\$*.c"o
    ifeq ($(TARGET_COMPILER), GreenHills Multi)
	$(CC) -c -MD $(CC_OPTS) $(CFLAGS) -o $@ $<
    else
	@$(CC) $(CC_OPTS) $(CFLAGS) $<
