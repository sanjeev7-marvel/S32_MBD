...
{
  /* Initialize model */
  ram_bam_download_s32k144_initialize();
}

void SYSTEM_TASK(void)
{
  ram_bam_download_s32k144_step();
...
const volatile uint32_t BOOTDATA[] __attribute__ ((section(".bootdata"))) = {
  0x015A015A,                          /* RCHW */
  (uint32_t) Reset_Handler,            /* APP */
  5000000000,                          /* DELAY */
  (uint32_t)&APPKEY };                 /* APPLOC */
