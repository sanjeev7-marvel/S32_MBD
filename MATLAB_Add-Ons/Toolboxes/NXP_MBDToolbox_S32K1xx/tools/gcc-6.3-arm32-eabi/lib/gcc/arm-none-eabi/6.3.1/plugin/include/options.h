...
enum opt_code
{
  ...
  OPT_mcallee_super_interworking = 1191,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1192,     /* -mcaller-super-interworking */
  OPT_mcmse = 1193,                          /* -mcmse */
  OPT_mcpu_ = 1194,                          /* -mcpu= */
  ...
  OPT_mpic_data_is_text_relative = 1204,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1205,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1206,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1207,               /* -mprint-tune-info */
  OPT_mpure_code = 1208,                     /* -mpure-code */
  OPT_mrestrict_it = 1209,                   /* -mrestrict-it */
  OPT_msched_prolog = 1210,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1211,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1212,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1213, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1214,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1215,                         /* -mthumb */
  OPT_mthumb_interwork = 1216,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1217,                  /* -mtls-dialect= */
  OPT_mtp_ = 1218,                           /* -mtp= */
  OPT_mtpcs_frame = 1219,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1220,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1221,                         /* -mtune= */
  OPT_munaligned_access = 1222,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1223,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1224,      /* -mvectorize-with-neon-quad */
  OPT_mword_relocations = 1225,              /* -mword-relocations */
  OPT_n = 1226,                              /* -n */
  OPT_no_canonical_prefixes = 1227,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1228,              /* -no-integrated-cpp */
  OPT_no_pie = 1229,                         /* -no-pie */
  OPT_nocpp = 1230,                          /* -nocpp */
  OPT_nodefaultlibs = 1231,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1232,                   /* -nostartfiles */
  OPT_nostdinc = 1233,                       /* -nostdinc */
  OPT_nostdinc__ = 1234,                     /* -nostdinc++ */
  OPT_nostdlib = 1235,                       /* -nostdlib */
  OPT_o = 1236,                              /* -o */
  OPT_p = 1237,                              /* -p */
  OPT_pass_exit_codes = 1238,                /* -pass-exit-codes */
  /* OPT_pedantic = 1239, */                 /* -pedantic */
  OPT_pedantic_errors = 1240,                /* -pedantic-errors */
  OPT_pg = 1241,                             /* -pg */
  OPT_pie = 1242,                            /* -pie */
  OPT_pipe = 1243,                           /* -pipe */
  ...
  OPT_quiet = 1255,                          /* -quiet */
  OPT_r = 1256,                              /* -r */
  OPT_remap = 1257,                          /* -remap */
  OPT_s = 1258,                              /* -s */
  OPT_s_bc_abi = 1259,                       /* -s-bc-abi */
  OPT_save_temps = 1260,                     /* -save-temps */
  OPT_save_temps_ = 1261,                    /* -save-temps= */
  OPT_shared = 1262,                         /* -shared */
  OPT_shared_libgcc = 1263,                  /* -shared-libgcc */
  /* OPT_specs = 1264, */                    /* -specs */
  OPT_specs_ = 1265,                         /* -specs= */
  OPT_static = 1266,                         /* -static */
  OPT_static_libasan = 1267,                 /* -static-libasan */
  OPT_static_libgcc = 1268,                  /* -static-libgcc */
  OPT_static_libgcj = 1269,                  /* -static-libgcj */
  OPT_static_libgfortran = 1270,             /* -static-libgfortran */
  OPT_static_libgo = 1271,                   /* -static-libgo */
  OPT_static_liblsan = 1272,                 /* -static-liblsan */
  OPT_static_libmpx = 1273,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1274,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1275,               /* -static-libstdc++ */
  OPT_static_libtsan = 1276,                 /* -static-libtsan */
  OPT_static_libubsan = 1277,                /* -static-libubsan */
  /* OPT_std_c__03 = 1278, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1279, */                /* -std=c++0x */
  OPT_std_c__11 = 1280,                      /* -std=c++11 */
  OPT_std_c__14 = 1281,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1282, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1283, */                /* -std=c++1y */
  OPT_std_c__1z = 1284,                      /* -std=c++1z */
  OPT_std_c__98 = 1285,                      /* -std=c++98 */
  OPT_std_c11 = 1286,                        /* -std=c11 */
  ...
  OPT_std_legacy = 1316,                     /* -std=legacy */
  OPT_symbolic = 1317,                       /* -symbolic */
  OPT_t = 1318,                              /* -t */
  OPT_time = 1319,                           /* -time */
  OPT_time_ = 1320,                          /* -time= */
  OPT_traditional = 1321,                    /* -traditional */
  OPT_traditional_cpp = 1322,                /* -traditional-cpp */
  OPT_trigraphs = 1323,                      /* -trigraphs */
  OPT_u = 1324,                              /* -u */
  OPT_undef = 1325,                          /* -undef */
  OPT_v = 1326,                              /* -v */
  OPT_version = 1327,                        /* -version */
  OPT_w = 1328,                              /* -w */
  OPT_wrapper = 1329,                        /* -wrapper */
  OPT_x = 1330,                              /* -x */
  OPT_z = 1331,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
