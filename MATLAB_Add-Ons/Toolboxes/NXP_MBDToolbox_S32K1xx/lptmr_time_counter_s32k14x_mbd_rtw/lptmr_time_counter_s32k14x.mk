...
MODEL                = lptmr_time_counter_s32k14x
MODULES              = mbd_main.c clock_S32K1xx.c gpio_irq.c interrupt_manager.c lpit_driver.c lptmr_driver.c lptmr_hw_access.c pins_driver.c pins_port_hw_access.c power_manager.c power_manager_S32K1xx.c power_smc_hw_access.c s32k_clock_init.c startup.c system_S32K144.c trgmux_driver.c trgmux_hw_access.c
MAKEFILE             = lptmr_time_counter_s32k14x.mk
...
MODELLIB                  = lptmr_time_counter_s32k14xlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	...
	-$(include_opt)$(START_DIR)\lptmr_time_counter_s32k14x_mbd_rtw \
	-$(include_opt)$(START_DIR)\S32_Examples\s32k14x\lptmr \
...
%.o : $(START_DIR)\mbdtbx_s32k\blocks\lptmr/%.c
	@echo ### "$(START_DIR)\mbdtbx_s32k\blocks\lptmr\$*.c"o
    ifeq ($(TARGET_COMPILER), GreenHills Multi)
