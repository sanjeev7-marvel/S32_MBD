...
MODEL                = flexcan_echo_s32k14x
MODULES              = fcan0_s32k_rx_isr.c mbd_main.c clock_S32K1xx.c edma_driver.c edma_hw_access.c edma_irq.c flexcan_driver.c flexcan_hw_access.c flexcan_irq.c interrupt_manager.c lpit_driver.c osif_baremetal.c pins_driver.c pins_port_hw_access.c power_manager.c power_manager_S32K1xx.c power_smc_hw_access.c s32k_clock_init.c startup.c system_S32K144.c
MAKEFILE             = flexcan_echo_s32k14x.mk
...
MODELLIB                  = flexcan_echo_s32k14xlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	...
	-$(include_opt)$(START_DIR)\flexcan_echo_s32k14x_mbd_rtw \
	-$(include_opt)$(START_DIR)\S32_Examples\s32k14x\fcan \
...
%.o : $(START_DIR)\mbdtbx_s32k\blocks\fcan/%.c
	@echo ### "$(START_DIR)\mbdtbx_s32k\blocks\fcan\$*.c"o
    ifeq ($(TARGET_COMPILER), GreenHills Multi)
