/*-----------------------------------------------------------------------------
% Copyright (c) 2006 NXP.
% All rights reserved.
-----------------------------------------------------------------------------*/
#define S_FUNCTION_NAME  ftm_s32k_tof_isr
...
/*============================================================================*/
{
    ...
    ---------------------------*/
    ssSetNumInputPorts(S, 0); /* Define 1 Input required */
    ssSetNumOutputPorts(S, 1); /* Define 1 Output required */
