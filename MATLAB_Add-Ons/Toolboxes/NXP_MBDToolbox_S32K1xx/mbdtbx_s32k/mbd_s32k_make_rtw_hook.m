%mbd_s32k_make_rtw_hook

% Copyright (c) 2018 NXP.
% All rights reserved.
function mbd_s32k_make_rtw_hook(hookMethod, modelName, rtwroot, templateMakefile, buildOpts, buildArgs, buildInfo)
        ...
        case 'before_make'
            try
                ...
                if strcmp(mbd_s32k_get_target_family, 's32k11')
                    ...
                    buildInfo.addTMFTokens('|>TARGET_MC_LIB<|', 'S32K11x_AMMCLIB.a', 'makevar');
                    ...
                    buildInfo.addTMFTokens('|>TARGET_MC_LIB<|', 'S32K14x_AMMCLIB.a', 'makevar');
                    if strcmp(mbd_s32k_get_config_param('target_compiler'), 'IAR')
