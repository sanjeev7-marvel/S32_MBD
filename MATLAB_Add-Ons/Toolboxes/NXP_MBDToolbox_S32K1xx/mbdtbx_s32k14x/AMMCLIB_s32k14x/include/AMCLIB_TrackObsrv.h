...
****************************************************************************/
  ...
  * parameter in definition of macro. 
  */
  #define AMCLIB_TrackObsrvInit_Dsptchr_2(pCtrl,Impl)         AMCLIB_TrackObsrvInit_Dsptchr_(pCtrl,Impl)          /* Function dispatcher for AMCLIB_TrackObsrvInit_Dsptchr_3, do not modify!!! */
