...
****************************************************************************/
  ...
  *//**********************************************************************/
  /* @remarks Implements DAMCLIB00006 */
  typedef struct
  {
    ...
    tFrac32 f32IGain;  /**< Scailing coefficient for current I_frac, fractional format normalized to fit into (-2\f$^{31}\f$, 2\f$^{31}\f$-1). */
    tFrac32 f32UGain;  /**< Scailing coefficient for voltage U_frac, fractional format normalized to fit into (-2\f$^{31}\f$, 2\f$^{31}\f$-1). */
    tFrac32 f32WIGain; /**< Scailing coefficient for angular speed WI_frac, fractional format normalized to fit into (-2\f$^{31}\f$, 2\f$^{31}\f$-1). */
    tFrac32 f32EGain;  /**< Scailing coefficient for back-EMF E_frac, fractional format normalized to fit into (-2\f$^{31}\f$, 2\f$^{31}\f$-1). */
...
****************************************************************************/
  ...
  *//**********************************************************************/
  ...
  typedef struct
  {
    ...
    SWLIBS_2Syst_F32  pIObsrvIn_1L;  /**< Inputs of RL circuit at step k-1 - low word */
    SWLIBS_2Syst_F16  pIObsrvIn_1H;  /**< Inputs of RL circuit at step k-1 - high word */
    tFrac16 f16IGain;  /**< Scailing coefficient for current I_frac, fractional format normalized to fit into (-2\f$^{15}\f$, 2\f$^{15}\f$-1). */
    tFrac16 f16UGain;  /**< Scailing coefficient for voltage U_frac, fractional format normalized to fit into (-2\f$^{15}\f$, 2\f$^{15}\f$-1). */
    tFrac16 f16WIGain; /**< Scailing coefficient for angular speed WI_frac, fractional format normalized to fit into (-2\f$^{15}\f$, 2\f$^{15}\f$-1). */
    tFrac16 f16EGain;  /**< Scailing coefficient for back-EMF E_frac, fractional format normalized to fit into (-2\f$^{15}\f$, 2\f$^{15}\f$-1). */
    tS16 s16Shift;     /**< Common gain shift, integer format [-14, 14]. Function accuracy guaranteed only for range [-1, 1]. */
