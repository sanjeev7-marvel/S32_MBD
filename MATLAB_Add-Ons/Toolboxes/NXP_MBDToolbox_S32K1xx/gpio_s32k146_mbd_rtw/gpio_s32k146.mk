...
MODEL                = gpio_s32k146
MODULES              = mbd_main.c clock_S32K1xx.c gpio_irq.c interrupt_manager.c lpit_driver.c pins_driver.c pins_port_hw_access.c power_manager.c power_manager_S32K1xx.c power_smc_hw_access.c s32k_clock_init.c startup.c system_S32K146.c
MAKEFILE             = gpio_s32k146.mk
...
ADD_INCLUDES = \
	...
	-$(include_opt)$(START_DIR)\gpio_s32k146_mbd_rtw \
